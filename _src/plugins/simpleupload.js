...
UE.plugin.register('simpleupload', function (){
    ...
    function initUploadBtn(){
        ...
        domUtils.on(btnIframe, 'load', function(){
            ...
            'style="' + btnStyle + '">' +
            '<input id="edui_input_' + timestrap + '" type="file" accept="image/jpeg, image/png, image/gif" name="' + me.options.imageFieldName + '" ' +
            'style="' + btnStyle + '">' +
            '</form>' +
            ...
            domUtils.on(input, 'change', function(){
                ...
                me.focus();
                me.execCommand('inserthtml', '<img class="loadingclass" id="' + loadingId + '" src="' + me.options.themePath + me.options.theme +'/images/spacer.gif"><p></p>');
